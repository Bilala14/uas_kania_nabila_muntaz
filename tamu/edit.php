...
$ambil = "SELECT * FROM tb_tamu WHERE id_tamu='$id_tamu'";
        ...
        <div class="col-8 m-auto">
            ...
            <form action="update.php" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" value="<?=$data['nm_tamu']?>" name="nama" class="form-control" id="exampleInputPassword1">
                </div>
                <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label">Nomor Identitas</label>
                    <input type="text" name="no_identitas" value="<?=$data['no_identitas']?>" class="form-control" id="exampleInputPassword1">
                </div>
